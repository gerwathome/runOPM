...
### Variable Definition
A simulation deck, suitably modified to include design variables, is called a deck template.  The modification  involves replacing portions of the deck with a variable that may be used to substitute in variations for exploring of the form *{$xperm}*
