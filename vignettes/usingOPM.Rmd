...
2. ***flow2csv*** converts Eclipse style output to a csv file and loads it
3. ***plotcase*** plots the simulator output data from the csv file

Here is an example running the [SPE1](http://www.ipt.ntnu.no/~kleppe/pub/SPE-COMPARATIVE/papers/first.pdf) test deck:
